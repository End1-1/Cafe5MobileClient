...
class SocketMessage {
  ...
  void setBuffer(Uint8List data) {
    ...
    _dataPosition += 3;
    int packetNumber = buffer
        .toBytes()
        .sublist(_dataPosition, _dataPosition + 4)
        .buffer
        .asByteData()
    ...
    command = buffer
        .toBytes()
        .sublist(_dataPosition, _dataPosition + 2)
        .buffer
        .asByteData()
  ...
  int getByte() {
    int r = buffer
        .toBytes()
        .sublist(_dataPosition, _dataPosition + 1)
        .buffer
        .asByteData()
        .getInt8(0);
    _dataPosition++;
  ...
  double getDouble() {
    double r = buffer
        .toBytes()
        .sublist(_dataPosition, _dataPosition + 8)
        .buffer
        .asByteData()
  ...
  String getString() {
    int sz = getInt();
    String str = utf8
        .decode(buffer.toBytes().sublist(_dataPosition, _dataPosition + sz));
    _dataPosition += sz;
    return str;
  }
  ...
  Uint8List data() {
    ...
    //packet number
    finalBuffer.add(Uint8List(4)
      ..buffer.asByteData().setInt32(0, packetNumber(), Endian.little));
    //message id
    finalBuffer.add(Uint8List(4)
      ..buffer.asByteData().setInt32(0, messageId, Endian.little));
    //command
    finalBuffer.add(
        Uint8List(2)..buffer.asByteData().setInt16(0, command, Endian.little));
    //data size
    finalBuffer.add(Uint8List(4)
      ..buffer.asByteData().setInt32(0, _dataSize, Endian.little));
    //data
