                ...
                child: Column(
                  ...
                  Row(
                    children: [
                      InkWell(
                          onTap: () {
                            AppDialog.getString(context, model.work)
                                .then((value) {
                              if (value != null) {
                                HttpQuery().request({
                      ...
                      builder: (builder, snapshot) {
                        ...
                        return Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('34', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('36', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('38', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('40', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('42', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('44', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('46', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('48', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('50', style: ts)),
                                Container(
                                    margin:
                                        const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    width: 50,
                                    child: const Text('52', style: ts)),
                                Container(
                            ...
                            for (final e
                                in snapshot.data! as List<WorkDetails>) ...[
                              Row(
                                children: [
                                  Container(
                                      margin:
                                  ...
                                  Container(
                                      ...
                                      child: InkWell(
                                          ...
                                          child:
                                              Text('${e.f_52p}', style: ts))),
                                  InkWell(
                                      onTap: () {
                                        AppDialog.question(context,
                                                tr('Confirm to remove'))
                                            .then((value) {
                                          if (value != null) {
                                            if (value) {
                                              HttpQuery().request({
