...
class WorkDetailsScreenDone extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const ts1 = TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.red);
    const ts2 = TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.green);
    const ts3 = TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.deepPurple);
    return AppHeader(
        '${model.work}',
        SingleChildScrollView(scrollDirection: Axis.horizontal, child: SingleChildScrollView(child: Column(
          ...
          Row(
            children: [
              InkWell(
                  onTap: () {
                    AppDialog.getStringInt(context, model.work).then((value) {
                      if (value != null) {
                        HttpQuery().request({
              ...
              InkWell(onTap:() {
                AppDialog.question(context, tr('Execute?')).then((value) {
                  if (value != null) {
                    model.completeList.forEach((key, value) {
                      ...
                      for (final e in value) {
                        HttpQuery().request({
                          ...
                          'f_color': key,
                          'f_field': 'f_${e}',
                          'f_qty': model.idQty[model.listId[key]!]![e],
                        });
                      }
                    });
                    model.getWorksDone();
          ...
          StreamBuilder(stream: model.listController.stream, builder: (builder, snapshot) {
            ...
            return Column(
              ...
              children: [
              Row(children: [
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 100, child: Text(tr('Color'), style: ts2,)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('34', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('36', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('38', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('40', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('42', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('44', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('46', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('48', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('50', style: ts2)),
                Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 50, child: const Text('52', style: ts2)),
              ],),
              for (final e in (snapshot.data ?? []) as List<WorkDetailsDone>) ... [
                Row(children: [
                  Container(margin: const EdgeInsets.fromLTRB(5, 5, 5, 5), width: 100, child: Text(e.f_color, style: ts2)),
